...
```bash
curl -fLO https://github.com/btsouth/omaroll/releases/download/v1.7.0/omaroll-1.7.0-1-x86_64.pkg.tar.zst \
     -fLO https://github.com/btsouth/omaroll/releases/download/v1.7.0/SHA256SUMS
sha256sum -c --ignore-missing SHA256SUMS
sudo pacman -U ./omaroll-1.7.0-1-x86_64.pkg.tar.zst
```
